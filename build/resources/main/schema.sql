...
create table record (record_id bigint not null auto_increment, created_at datetime(6), is_deleted BIT(1) DEFAULT b'0' not null, updated_at datetime(6), date date, note varchar(255), result json, user_id bigint, wod_id bigint, primary key (record_id)) engine=InnoDB;
